...
# Plot 2 ("plot2.png") using the base plotting system -- i.e., a 480x480 pixel
# line graph of global active power as a time series between 01FEB2007 and
# 02FEB2007.
#
# ARG(S): N/A
#
# RETURNS: plot2.png (output file)
#
# INSPIRATION(S): N/A
#
# NOTE:
...
# > setwd(<PROJECTROOT>)
# > source(file.path(<CODEDIR>, "plot2.R"))
#
# EXAMPLE: N/A
#
# DATE:      AUTHOR:  COMMENT:
...
# Plot variables.
plot(x, y, type="l", col=plot.colors[1],
     xlab="",
